    ...
    <nav class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container-fluid">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="/">ScaryCode</a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    <div class="post-heading">
                        <h1>@yield('title')</h1>
                        <h2 class="subheading">@yield('subtitle')</h2>
                        <span class="meta">Posted by <a href="#">@yield('author')</a> at @yield('created_at') on <a href="#">@yield('category')</a></span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                    @yield('content')
                    <br/>
                    <div class="fb-like" data-share="true" data-layout="button_count" data-size="small" data-show-faces="true"></div>
                </div>
                <!-- FB Follow -->
